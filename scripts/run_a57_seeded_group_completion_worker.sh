...
OUTPUT=$RUN_ROOT/$SCENE/eval_seeded_group_completion
...
CUDA_VISIBLE_DEVICES=$GPU "$PYTHON_BIN" -u \
  ...
  --group_readout equal_query_seeded_group_completion \
  ...
  --group_completion_minimum_contact 0.05 \
